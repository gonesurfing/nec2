...
echo "Step 7: Compile integrated main program (nec2dxs_integrated.f)"
...
echo "Step 8: Link to create executable"
gfortran -O0 nec2dxs_integrated.o nec2d_io.o nec2d_geometry.o nec2d_mathutil.o nec2d_simple.o nec2d_bessel.o nec2d_kernels.o -o nec2dxs_integrated
if [ $? -eq 0 ]; then
