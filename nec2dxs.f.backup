...
C***
      REAL*8 HPOL,PNET
      INTEGER*2   LLNEG
C     Local COMPLEX*16 variables (COMMON block vars now from module)
      COMPLEX*16  FJ,ETH,EPH,CURI,EX,EY,EZ,EPSC
C     Most COMMON blocks now provided by USE NEC2_COMMON
C     /DATA/ kept local due to EQUIVALENCE statements below
